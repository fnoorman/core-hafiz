        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="<?=Url::to(['lookup/index'])?>"><i class="fa fa-search"></i> <span class="nav-label">Lookup</span></a>
                    </li>

                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Analytics</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                    ...
                    <li>
                        <a href="<?=Url::to(['package/index'])?>"><i class="fa fa-gift"></i> <span class="nav-label">Package </span></a>
