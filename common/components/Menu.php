...
class Menu extends Widget
{
     ...
     */
    public $linkTemplateWithIcon = '<a href="{url}"><i class="{icon}"></i><span class="nav-label">{label}</span></a>';
    public $linkTemplate = '<a href="{url}"><span class="nav-label">{label}</span></a>';
    /**
    ...
    protected function renderItem($item)
    {
        if (isset($item['url'])) {
            ...
            {
                $template = ArrayHelper::getValue($item, 'template', $this->linkTemplateWithIcon);
